...
The current ComfyUI 0.34.0 deployment supersedes this launch policy: both local
...
source pin is the immutable v0.34.0 commit
`12d5279438bfefc058a269eae805ceab6047777f`, paired with `comfy-kitchen==0.2.31`.
